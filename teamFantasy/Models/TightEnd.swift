...
class TightEnd {
    ...
    required init(json: JSON) throws {
        ...
        receptions = try? json.getString(at: Constants.TightEnd.receptions)
        recYds = try? json.getString(at: Constants.TightEnd.recYds)
        recTD = try? json.getString(at: Constants.TightEnd.recTD)
    ...
    func path() -> String {
        ...
        case .receptions, .recYds, .recTD:
            return "/service/weekly-projections/json/test/TE/1/"
    ...
    func toDictionary() -> [String: AnyObject]? {
        ...
        case .receptions:
            ...
            params[Constants.TightEnd.receptions] = receptions as AnyObject?
        case .recYds:
            params[Constants.displayName] = displayName as AnyObject?
            params[Constants.TightEnd.recYds] = recYds as AnyObject?
        case .recTD:
            params[Constants.displayName] = displayName as AnyObject?
            params[Constants.TightEnd.recTD] = recTD as AnyObject?
        }
